...
const onSelectLanguage = (action) => {
  ...
  currentLanguage.value = action.text;
};
...
<template>
  <div class="content">
    ...
    <div class="rule">
      <div class="rule-left">
        <div class="left-title">I LAF做市商投资规则</div>
        <div class="left-tip">捐赠底池后按捐赠额，每日最高1.2%自动复利，每次最高30元。</div>
      </div>
    ...
    <Modal
      ...
      title="增加资产"
      :show-input="true"
      input-placeholder="请输入增加金额"
      :max-amount="1000"
      :show-dropdown="true"
      :dropdown-options="[{ text: '1天,复利0.3%' }, { text: '15天,复利0.6%' }, { text: '30天,复利1.2%' },]"
